...
Sieć klientów sieci sklepów Lidl, gdzie połączenie oznacza dokonanie transakcji między węzłami. W takiej sieci można by było zauważyć podgrafy zbliżone do grafów typu "gwiazda" (star graph).

### Sieć asortatywna
Sieć odizolowanych od siebie plemion o bardzo różnej ilości wielości społeczności. Taka sieć składałaby się z podgrafów "prawie-pełnych" (prawie wszyscy się znają w obrębie plemienia)

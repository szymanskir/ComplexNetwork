...
Poza pierwszymi 30 iteracjami wartości współczynnika $\alpha$ utrzymują się w przediale $\[3, 3.3\]$. Zgadza się to z wynikami teoretycznymi z wykładu.
...
Wartośći otrzymane za pomocą uzyskanego wzoru $P(k) = \frac{2m^2}{k^3}$ pokrywają się z empirycznymi wynikami zadania 3.
